...
<section class="product-detail-body">
  ...
  {{-- Full Description (Markdown rendered via league/commonmark) --}}
  @if($product->full_description)
  @php
    use App\Models\SiteSetting;
    $fullDescHtml = SiteSetting::renderMarkdown($product->full_description);
  @endphp
  <div class="product-full-desc">
    <h2>Product Details</h2>
    <div class="cms-prose detail-prose">{!! $fullDescHtml !!}</div>
  </div>
  @endif
</section>
