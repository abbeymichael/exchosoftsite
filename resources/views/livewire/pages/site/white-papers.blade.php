...
<style>
  ...
  @media(max-width:1024px){.listing-body{padding:2.5rem 2rem;}}
</style>
<x-page-banner
    tag="Deep Dives"
    title="Technical Research & **Industry Analysis**"
    subtitle="In-depth technical guides, ROI analyses, and research papers from the Exchosoft team — including the ChurchOps ROI white paper and more."
